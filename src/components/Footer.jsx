              ...
              <div className="flex flex-col gap-7">
                ...
                <div className="sm:block hidden">
                  ...
                  <ul className="space-y-2">
                    <li>
                      <a
                        href="https://drive.google.com/file/d/16eYXo6FosoxC-kUpzNsqkvyj9T7HB4Zk/view?usp=drivesdk"
                    ...
                    <li>
                      <a
                        href="https://drive.google.com/file/d/12VvSNvT-RqOV1JzozY5LOuxzoTF0rSse/view?usp=drivesdk"
                        className="hover:underline"
                      >
                        Startup Expo
                      </a>
                    ...
                    <li>
                      <a
                        href="https://drive.google.com/file/d/1WgQUrUpfK738wxHA-F4Lbs65IEHIdHZF/view?usp=drivesdk"
                        className="hover:underline"
                      >
